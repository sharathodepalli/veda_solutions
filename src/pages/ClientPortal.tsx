...
import { Lock, User, Eye, EyeOff, Shield, FileText, BarChart3, MessageSquare, Settings, LogOut } from 'lucide-react';
        ...
        <section className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-neutral-200 leading-relaxed">
              Access your account, view reports, manage services, and communicate with our team 
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700 text-sm leading-relaxed">
                    ...
                    and we maintain strict HIPAA compliance standards to protect your sensitive information.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-soft">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-neutral-600 text-sm">This Month's Savings</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl p-6 shadow-soft mb-8">
                <h2 className="text-xl font-bold text-primary-900 mb-6">Active Services</h2>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                    <div>
                      <h3 className="font-semibold text-primary-900">EHR Optimization</h3>
                      <p className="text-neutral-600 text-sm">Last updated: 2 days ago</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                    <div>
                      <h3 className="font-semibold text-primary-900">Virtual Medical Scribes</h3>
                      <p className="text-neutral-600 text-sm">Last session: Today, 3:00 PM</p>
                    </div>
                    <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-medium">
                      Active
                    </span>
                  ...
                  <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                    <div>
                      <h3 className="font-semibold text-primary-900">Revenue Cycle Management</h3>
                      <p className="text-neutral-600 text-sm">Monthly report generated</p>
                    </div>
                    <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-medium">
                      Active
                    </span>
              ...
              {/* Recent Reports */}
              <div className="bg-white rounded-2xl p-6 shadow-soft">
                <h2 className="text-xl font-bold text-primary-900 mb-6">Recent Reports</h2>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 hover:bg-neutral-50 rounded-xl transition-colors duration-200">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-primary-900">Monthly Revenue Report - December 2024</p>
                        <p className="text-neutral-600 text-sm">Generated on Dec 15, 2024</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 hover:bg-neutral-50 rounded-xl transition-colors duration-200">
                    <div className="flex items-center space-x-3">
                      <FileText className="w-5 h-5 text-primary-500" />
                      <div>
                        <p className="font-medium text-primary-900">EHR Optimization Summary</p>
                        <p className="text-neutral-600 text-sm">Generated on Dec 10, 2024</p>
                      </div>
                    </div>
                    <button className="text-primary-500 hover:text-primary-600 font-medium text-sm">
                      Download
                  ...
                  <div className="flex items-center justify-between p-3 hover:bg-neutral-50 rounded-xl transition-colors duration-200">
                    <div className="flex items-center space-x-3">
                      <FileText className="w-5 h-5 text-primary-500" />
                      <div>
                        <p className="font-medium text-primary-900">Virtual Scribe Performance Report</p>
                        <p className="text-neutral-600 text-sm">Generated on Dec 8, 2024</p>
                      </div>
                    </div>
                    <button className="text-primary-500 hover:text-primary-600 font-medium text-sm">
                      Download
            ...
            <div className="space-y-8">
              ...
              {/* Recent Messages */}
              <div className="bg-white rounded-2xl p-6 shadow-soft">
                <h2 className="text-xl font-bold text-primary-900 mb-6">Recent Messages</h2>
                <div className="space-y-4">
                  <div className="p-3 bg-blue-50 rounded-xl">
                    <p className="font-medium text-blue-900 text-sm">System Update</p>
                    <p className="text-blue-700 text-sm">EHR optimization completed successfully</p>
                    <p className="text-blue-600 text-xs mt-1">2 hours ago</p>
                  </div>
                  <div className="p-3 bg-green-50 rounded-xl">
                    <p className="font-medium text-green-900 text-sm">Support Response</p>
                    <p className="text-green-700 text-sm">Your ticket has been resolved</p>
              ...
              {/* Account Manager */}
              <div className="bg-white rounded-2xl p-6 shadow-soft">
                <h2 className="text-xl font-bold text-primary-900 mb-6">Your Account Manager</h2>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  />
                  <div>
                    <p className="font-semibold text-primary-900">Sarah Williams</p>
                    <p className="text-neutral-600 text-sm">Senior Account Manager</p>
                  </div>
                </div>
