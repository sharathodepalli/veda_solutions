...
const urgencyLevels = [
  { id: 'low', name: 'Low Priority', description: 'Can wait 2-4 weeks', color: 'text-green-600 bg-green-50' },
  { id: 'medium', name: 'Medium Priority', description: 'Needed within 1-2 weeks', color: 'text-yellow-600 bg-yellow-50' },
  { id: 'high', name: 'High Priority', description: 'Needed within days', color: 'text-orange-600 bg-orange-50' },
  { id: 'urgent', name: 'Urgent', description: 'Immediate attention required', color: 'text-red-600 bg-red-50' }
];
      ...
      <section className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-neutral-200 leading-relaxed mb-8">
            Tell us about your specific needs and we'll create a customized solution for your practice. 
            Our experts will review your request and provide a detailed proposal within 24 hours.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-600">Choose the service that best fits your practice needs</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {serviceTypes.map((service) => (
              <div key={service.id} className="bg-neutral-50 rounded-xl p-6 hover:bg-neutral-100 transition-colors duration-200">
                <h3 className="font-semibold text-primary-900 mb-2">{service.name}</h3>
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-soft-lg">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600">
                Provide as much detail as possible to help us create the perfect solution for your practice.
              </p>
            </div>
            ...
            >
              ...
              {/* Service Selection */}
              <div>
                <h3 className="text-xl font-semibold text-primary-900 mb-6">Service Type *</h3>
              ...
              {/* Urgency Level */}
              <div>
                <h3 className="text-xl font-semibold text-primary-900 mb-6">Priority Level *</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Project Details */}
              <div>
                <h3 className="text-xl font-semibold text-primary-900 mb-6">Project Details</h3>
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Current Situation</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Desired Outcome</label>
                    <textarea
                      name="desiredOutcome"
                      rows={3}
              ...
              {/* Timeline and Budget */}
              <div>
                <h3 className="text-xl font-semibold text-primary-900 mb-6">Timeline & Budget</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Preferred Timeline</label>
                    <select
                      name="timeline"
              ...
              <div>
                <h3 className="text-xl font-semibold text-primary-900 mb-6">Additional Requirements</h3>
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">Special Requirements or Constraints</label>
                    <textarea
              ...
              {selectedService && (
                <div className="bg-primary-50 rounded-2xl p-6 border border-primary-200">
                  <h3 className="text-lg font-semibold text-primary-900 mb-3">Service Summary</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <div className="text-sm text-primary-700 font-medium">Selected Service:</div>
                      <div className="text-primary-900">{selectedService.name}</div>
                    </div>
                    <div>
                      <div className="text-sm text-primary-700 font-medium">Estimated Setup Time:</div>
                      <div className="text-primary-900">{selectedService.estimatedTime}</div>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <h3 className="font-semibold text-primary-900 mb-2">24-Hour Response</h3>
              <p className="text-neutral-600 text-sm">Quick turnaround on proposals</p>
            </div>
            <div>
              <Users className="w-12 h-12 text-blue-500 mx-auto mb-3" />
              <h3 className="font-semibold text-primary-900 mb-2">Expert Team</h3>
              <p className="text-neutral-600 text-sm">Healthcare technology specialists</p>
            </div>
            <div>
              <Award className="w-12 h-12 text-accent-500 mx-auto mb-3" />
              <h3 className="font-semibold text-primary-900 mb-2">Proven Results</h3>
              <p className="text-neutral-600 text-sm">500+ successful implementations</p>
            </div>
          </div>
        </div>
      </section>
